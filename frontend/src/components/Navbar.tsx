...
export default function Navbar() {
  ...
  // IMPORTANT:
  // setRedirectTo has been removed because AuthContext does not provide it.
  ...
  const handleLogout = () => {
    ...
    // If the user logs out while on a protected page,
    // send them to login.
    if (pathname === "/services" || pathname.startsWith("/dashboard")) {
      router.push("/login");
    }
  };
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl hover:bg-white/[0.05] text-ink-secondary cursor-pointer min-w-[44px] min-h-[44px] flex items-center justify-center"
              aria-label={
      ...
      {mobileOpen && (
        <div
          className="md:hidden border-t border-border glass animate-fade-in-up max-h-[calc(100vh-4rem)] overflow-y-auto"
